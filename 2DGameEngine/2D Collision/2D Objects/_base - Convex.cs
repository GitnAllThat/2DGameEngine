    ...
    public abstract class ConvexRigidBody : RigidBody
    {
        ...
        public override void Draw(XnaWindow xnaWindow)
        {
            ...
            if (Globals.FILLRIGIDBODY)
            {
                ...
                {
                    pass.Apply();
                    xnaWindow.Editor.GraphicsDevice.DrawUserIndexedPrimitives(PrimitiveType.TriangleList, vpc, 0, vpc.Length, indices, 0, indices.Length / 3, VertexPositionColor.VertexDeclaration);
                }
            }
            ...
            {
                pass.Apply();
                xnaWindow.Editor.GraphicsDevice.DrawUserPrimitives<VertexPositionColor>(PrimitiveType.LineStrip, vpc, 0, vpc.Length - 1);
            }
        }

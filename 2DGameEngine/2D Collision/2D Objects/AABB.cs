...
namespace _2d_Objects
{
    public class AABB 
    {
        ...
        public void Draw(XnaWindow xnaWindow, Color colour)
        {
            ...
            foreach (EffectPass pass in xnaWindow.effect.CurrentTechnique.Passes)
            {
                ...
                xnaWindow.Editor.GraphicsDevice.DrawUserPrimitives<VertexPositionColor>(PrimitiveType.LineStrip, vpc, 0, 4);
            }
        }
    }
}

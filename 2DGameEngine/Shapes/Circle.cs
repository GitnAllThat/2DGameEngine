    ...
    public class Circle
    {
        ...
        public void Draw(XnaWindow monogameWindow)
        {
            ...
            if (this.FillCircle)
            {
                ...
                {
                    pass.Apply();
                    monogameWindow.Editor.GraphicsDevice.DrawUserIndexedPrimitives(PrimitiveType.TriangleList, this.vpcArray, 0, this.vpcArray.Length, indices, 0, indices.Length / 3, VertexPositionColor.VertexDeclaration);
                }
            }
            ...
            if (this.HasOutline)
            {
                ...
                {
                    pass.Apply();
                    monogameWindow.Editor.GraphicsDevice.DrawUserPrimitives<VertexPositionColor>(PrimitiveType.LineStrip, vpcArray, 0, vpcArray.Length - 2);
                }
            }
        }

        public void DrawScreenSpace(XnaWindow monogameWindow)
        {
            Matrix worldMatrix = Matrix.CreateTranslation(this.vPosition);

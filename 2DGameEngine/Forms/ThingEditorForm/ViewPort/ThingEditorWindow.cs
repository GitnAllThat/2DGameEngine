...
namespace CustomControls
{
    ...
    public partial class ThingEditorWindow : XnaWindow
    {
        ...
        public ThingEditorForm form { get; set; }
        ...
        protected override void OnParentChanged(EventArgs e)
        {
            ...
            if (this.Parent is ThingEditorForm parentForm)
            {
        ...
        protected override void Draw()
        {
            ...
            Editor.spriteBatch.DrawString(DrawFont, $"is mouse on screen: {this.gameInput.isMouseOnScreen} ", new Vector2(
                    Editor.GraphicsDevice.Viewport.Width,
                    Editor.GraphicsDevice.Viewport.Height + - 10),
                    Color.Yellow);

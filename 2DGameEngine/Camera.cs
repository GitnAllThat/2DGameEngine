...
namespace _2DLevelCreator
{
    public class Camera
    {
        ...
        public void CameraMovement(GameInput gameInput, XnaWindow monoGameWindow)
        {
            #region Camera Zoom
            ...
            {
                float distance = Vector3.Distance(monoGameWindow.gameInput.GetWorldMouseCoords_XYPlane(this, gameInput.mousePositionCurrent, 0, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferWidth, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferHeight), monoGameWindow.gameInput.GetWorldMouseCoords_XYPlane(this, gameInput.mousePositionPrevious, 0, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferWidth, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferHeight));
                if (Vector3.Dot(new Vector3(0.5f, -0.5f, 0), monoGameWindow.gameInput.GetWorldMouseCoords_XYPlane(this, gameInput.mousePositionCurrent, 0, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferWidth, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferHeight) - monoGameWindow.gameInput.GetWorldMouseCoords_XYPlane(this, gameInput.mousePositionPrevious, 0, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferWidth, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferHeight)) > 0)
                {
                    distance = -distance;
                }
                distance *= 6;
            ...
            {
                this.CameraPosition += monoGameWindow.gameInput.GetWorldMouseCoords_XYPlane(this, gameInput.mousePositionPrevious, 0, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferWidth, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferHeight) -
                                        monoGameWindow.gameInput.GetWorldMouseCoords_XYPlane(this, gameInput.mousePositionCurrent, 0, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferWidth, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferHeight);
            }
        ...
        /// </summary>
        public void FocusOnPosition(Vector3 position, XnaWindow monoGameWindow, float planeDepth)
        {
        ...
        /// </summary>
        public Vector3 CalculateCameraCenter(XnaWindow monoGameWindow, float planeDepth)
        {
            Vector3 TopLeft = monoGameWindow.gameInput.GetWorldMouseCoords_XYPlane(this, new Vector3(0, 0, 0), planeDepth, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferWidth, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferHeight);
            Vector3 TopRight = monoGameWindow.gameInput.GetWorldMouseCoords_XYPlane(this, new Vector3(monoGameWindow.Editor.GraphicsDevice.Viewport.Width, 0, 0), planeDepth, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferWidth, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferHeight);
            Vector3 BottomRight = monoGameWindow.gameInput.GetWorldMouseCoords_XYPlane(this, new Vector3(monoGameWindow.Editor.GraphicsDevice.Viewport.Width, monoGameWindow.Editor.GraphicsDevice.Viewport.Height, 0), planeDepth, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferWidth, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferHeight);
            Vector3 BottomLeft = monoGameWindow.gameInput.GetWorldMouseCoords_XYPlane(this, new Vector3(0, monoGameWindow.Editor.GraphicsDevice.Viewport.Height, 0), planeDepth, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferWidth, monoGameWindow.Editor.GraphicsDevice.PresentationParameters.BackBufferHeight);
